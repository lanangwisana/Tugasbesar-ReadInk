    ...
    <div class="p-4 sm:ml-64">
        <div class="relative">
            <div>
                ...
                <form class="max-w-sm mx-auto" action="/add-tulis-author/{{$tulis->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="relative flex flex-row"> 
                        <div class=" absolute top-[0px] -right-[120px] w-[900px] p-5 border border-lg bg-white rounded shadow">
                            ...
                            <div class="">                                      
                                ...
                                <img src="{{ asset('storage/photo/' . $tulis->sampul) }}" alt="{{ $tulis->judul }}" class="w-[150px] h-[150px] mt-5" >
                            </div>
                            <div class="flex flex-row gap-x-5 justify-end mb-3 mt-5">
                                ...
                                <button type="submit" class="text-white bg-sky-500 hover:bg-sky-700 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Ubah
                                </button>
                            </div>
                        </div>
                    </div>
