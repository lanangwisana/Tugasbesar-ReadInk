...
<body class="bg-sky-100">
    ...
    <div class="p-4 sm:ml-64">
        <div class="relative">
        <div class="absolute -top-[37px] -left-4 z-10 bg-sky-100">
                {{-- Navbar start --}}
            ...
            <div>
                ...
                <div class="z-0 ">
                    <div class="relative top-[200px]">
                        <div class="relative top-5 flex flex-row p-3 border border-gray-50 border-lg shadow rounded w-1/2 bg-white mt-5 mb-5">
                            <div class="">
                                <img src="{{ asset('storage/photo/' . $story->sampul) }}" alt="{{ $story->judul }}" class="w-[150px] h-[200px]">
                            </div>
                            <div class="flex flex-col ms-5">
                                <h3 class="font-bold text-xl text-black">{{$story->judul}}</h3>
                                <h5>Author: {{$story->penulis}}</h5>
                                <h5 class="mt-10">Dipublis: {{$story->tglrilis}}</h5>
