                ...
                <div class="mt-[100px]">
                    ...
                    <div class="relative flex flex-row items-center justify-center h-48 mb-4 mt-[300px] gap-x-4 dark:bg-gray-800">
                        ...
                        <a href="" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="absolute -top-[250px] left-[115px] object-cover w-full rounded-lg h-96 p-3 md:h-auto md:w-[300px] md:rounded-none md:rounded-s-lg z-10" src<img class="h-20 w-auto" src="{{ asset('storage/photo/' . $cerita->sampul) }}" alt="{{ $cerita->judul }}">>
                            <div class="absolute -bottom-[25px] left-[100px] bg-white shadow border border-lg rounded flex flex-col justify-between p-4 leading-normal w-[1200px] h-[400px] z-0">
                                <div class="flex flex-row">
                                    <div class="flex absolute top-[15px] left-[320px] mb-5">
                                        ...
                                        <p class="mt-1 ms-2">{{$cerita->genre}}</p>
                                        <p class="mt-1 ms-2">{{$cerita->tglrilis}}</p>
                                    </div>
                                    <p class="absolute top-[15px] left-[1000px] flex text-right gap-2">
                                        {{-- Like --}}
                                        <a href="/fav-create/{{$cerita->id}}">
                                        ...
                                        {{-- Bookmark --}}
                                        <a href="/bookmark-create/{{ $cerita->id }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="auto" viewBox="0 0 40 40" fill="none">
                                ...
                                <h5 class="mt-7 ms-[310px] text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{$cerita->judul}}</h5>
                                <p class="mt-2 ms-[310px] font-normal text-gray-700 dark:text-gray-400">Author: {{$cerita->penulis}}</p>
                                <h5 class="mt-3 ms-[310px] font-normal text-gray-700 dark:text-gray-400">Sinopsis:</h5>
                                <p class="mb-3 ms-[310px] font-normal text-gray-700 dark:text-gray-400">{{$cerita->sinopsis}}</p>
                                <p class=" absolute top-[370px] left-[900px] p-5 bg-white rounded w-[150px] text-center"> <a href="/mulaibaca-author">Mulai baca</a></p>
                            </div>
                        </a>
                    </div>
