...
<body class="bg-sky-100">
    ...
    <div class="p-4 sm:ml-64">
        <div class="relative">
            ...
            <div>
                <div class="flex flew-row mt-5 justify-between">
                    <p class="text-xl font-bold text-center">Isi Cerita</p>
                    <a href="/add-isicerita" class="ml-96">
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah Isi Cerita</button>
                    </a>
                </div>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @foreach ($cerita as $key => $story)
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $cerita->firstItem( + $key) }}
                                </th>
                                {{-- relative bottom-[1400px] --}}
                                <td class="px-6 py-4">                                 
                                    {{ $story->judul }}
                                </td> 
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <a href="/isicerita/{{ $story->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">IsiCerita</a>
                                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">|</a>
                                    <a href="/edit-isi/{{ $story->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">|</a>
                                    <a href="/delete-isicerita/{{ $story->id }}" class="font-medium text-red-600 dark:text-blue-500 hover:underline">Hapus</a>
                                </td>
                                @endforeach
                        </tbody>
                    </table>
