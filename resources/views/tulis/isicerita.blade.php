    ...
    <script>
        tailwind.config = {
            ...
            content: [
                ...
                './resources/**/*.js',
                './resources/**/*.vue',
                './vendor/laravel/framework/src/Illuminate/Pagination/resources/views/isicerita.blade.php',
            ],
        }
    </script>
    {{-- Custom CSS --}}
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            ...
                            {{-- <div class="row">
                                <div>Judul</div>
                                <div>:</div>
                                <div>{{ $cerita->judul }}</div>
                            </div>
                            <div class="row">
                                <div>Isi Cerita</div>
                                <div>:</div>
                                <div>{{ $cerita->isicerita }}</div>
                            </div> --}}
                        </thead>
                        <tbody>
                            ...
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="/isicerita/{{ $story->judul }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"></a>
                                </td>
                                
                                @endforeach
                                <div class="flex flew-row mt-5 justify-between">
                                    <p class="text-xl font-bold text-center">Isi Cerita</p>
                                    <a href="/detail-cerita/{id}" class="ml-96">
