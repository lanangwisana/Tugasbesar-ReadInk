    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-sky-500 rounded-r-lg my-5" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-brown1 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="/homepage-author" class="flex items-center p-2 text-white rounded-lg bg-sky-700 dark:text-white dark:hover:bg-gray-700 group">
            ...
            <div class="absolute -top-[117px] -left-4">
                <div class="relative top-[30px] left-[450px] text-center">
                    <div class="flex flex-col">
                        <h2 class="text-2xl font-bold">Manhwa Solo Leveling</h2>
            ...
            <div>
                ...
                <div class="mt-[100px]">
                    ...
                    <div class="flex flex-row relative bottom-[130px]">
                        <img class="relative top-5 left-[180px] w-[1300px] h-[1050px] z-1" src="{{ asset('img/bukubg.png') }}" alt="">
                        <div class="absolute left-56 top-40 w-[1100px] h-[400px] z-10">
                            ...
                            <div class="text-right">
                                <a href="/halamanbaca-author" class="ml-96">
                        ...
                        <img class="w-[180px] h-[200px] relative top-[150px] right-[1200px]" src="{{ asset('img/Sungjinwoo.jpeg') }}" alt="">
                    </div>
